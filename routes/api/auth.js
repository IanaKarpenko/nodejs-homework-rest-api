...
const {userRegisterJoiSchema, userLoginJoiSchema, userSubscriptionJoiSchema, userSecondVerificationJoiSchema } = require("../../models/user");
...
router.get("/verify/:verificationToken", controlslWrapper(userControls.verification));

router.post("/verify", validation(userSecondVerificationJoiSchema), controlslWrapper(userControls.sendRepeatVerification));
